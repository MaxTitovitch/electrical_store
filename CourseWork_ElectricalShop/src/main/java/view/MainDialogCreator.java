...
public class MainDialogCreator {
    ...
    public MainDialogCreator (int port, String logFile, String configFile, CDialog frameDialog){
        ...
        mainDialog = new CDialog("СЕРВЕР: Магазин электротоваров. Курсовой проект", 500, 270);
        prepareMainDialog();
    ...
    private void prepareMainDialog(){
        mainDialog.addLabel(400, 30,50, 20, "Данные сервера:");
        mainDialog.addTextField(400, 30,50, 50);
        mainDialog.addLabel(400, 30,50, 100, "Количество клиентов:");
        mainDialog.addTextField(400, 30,50, 130);
        mainDialog.addButton(400, 30, 50, 180, "СТОП");
    }
